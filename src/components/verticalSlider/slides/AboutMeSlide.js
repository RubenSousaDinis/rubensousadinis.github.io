...
export default class AboutMeSlide extends React.Component {
  ...
  render() {
    ...
    const background = "img/section_2.jpg"
        ...
        <picture style={ { backgroundImage: "url(" + background + ")" } } />
          ...
          <div>
            ...
            <p>
              ...
              I love to travel, you can check some of my adventures here. 
              I’m also passionate with sports, I’ve a workout routine, which is composed by gym activities, soccer and some runs (I’ve already run an half-marathon). 
              In my free time I like to go out with friends, learn new stuff and support my favourite soccer team, you can check some pics here.
            </p>
